...
from detectron.detectron2.data import DatasetCatalog, MetadataCatalog
from detectron.detectron2.utils.comm import all_gather, is_main_process, synchronize
